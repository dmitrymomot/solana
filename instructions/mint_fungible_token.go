...
// MintFungibleTokenParam defines the parameters for the MintFungibleToken instruction.
type MintFungibleTokenParam struct {
...
// MintFungibleToken creates instructions for minting fungible tokens.
func MintFungibleToken(params MintFungibleTokenParam) InstructionFunc {
	return func() ([]types.Instruction, error) {
		...
		if params.Decimals == 0 {
			return nil, fmt.Errorf("field Decimals must be greater than 0")
		}
